<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse " id="pagesExamples">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('rincian_kategori.index') }}">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('sub_kategori.index') }}">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('musik.index') }}">
                                <span class="sidenav-mini-icon"> R </span>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#menuVideo" class="nav-link " aria-controls="menu-video"
                    role="button" aria-expanded="false">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                    ...
                    <span class="nav-link-text ms-1">Video Wedding </span>
                </a>
                <div class="collapse " id="menuVideo">
                    <ul class="nav ms-4 ps-3">

                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('kategori_video.index') }}">
                                <span class="sidenav-mini-icon"> P </span>
                                <span class="sidenav-normal"> Kategori Video </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('rincian_kategori_video.index') }}">
                                <span class="sidenav-mini-icon"> M </span>
                                <span class="sidenav-normal">Rincian Kategori Video </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('video_wedding.index') }}">
                                <span class="sidenav-mini-icon"> R </span>
                                <span class="sidenav-normal"> Video Wedding </span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('data-pembayaran') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <div class="sidenav-footer mx-3 ">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            <div class="full-background" style="background-image: url('../admin/img/curved-images/white-curved.jpeg')">
            </div>
