                        ...
                        <div class="container-fluid">
                            ...
                            <form method="POST" id="form-staff">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="nomor_telepon" type="text"
...
@push('script')
    <script>
        ...
        formStaff.addEventListener('submit', function(e) {
            ...
            axios.post("{{ route('staff.store') }}", formData)
                .then(function(response) {
                    if (response.status == 200) {
                        ...
                        if (dataError) {
                            ...
                            if (dataError.foto) {
                                let StaffFoto = document.getElementById('validationFoto')
                                foto.classList.add("is-invalid")
                                StaffFoto.innerText = dataError.foto[0]
                                StaffFoto.style.display = "block"
                            }
