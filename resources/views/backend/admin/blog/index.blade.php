                            ...
                            <tbody>
                                @forelse ($dataBlog as $blog)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="text-secondary text-xs font-weight-bold">{{$blog->tanggal}}</span>
                                        </td>
                                        <td class="text-center">
                                            <div class="text-center form-check form-switch ps-0">
                                                <input data-id="{{$blog->id_blog}}" class="toggle-class form-check-input ms-auto" type="checkbox" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $blog->isActive ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <span class="badge badge-sm bg-gradient-warning">
                                                <a href="{{ route('blog.preview', $blog->slug) }}" target="_blank" class="text-white">
    ...
    $(function() {
        $('.toggle-class').change(function() {
            ...
            $.ajax({
                ...
                data: {'status': status, 'id_blog': id_blog},
