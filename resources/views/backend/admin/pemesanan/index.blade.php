                    ...
                    <div class="card" id="tSelesai">
                        <div class="row">
                            <div class="col-lg-3 template">
                                <img src="{{ asset("gambar/gambar_cover_template/$pesananSemua->gambar_cover") }}" class="img-fluid mx-auto" alt="" />
                            </div>
                            <div class="col-lg-9 isi">
                                ...
                                <div class="npalw">
                                    <h3 class="my-4">{{$pesananSemua->nama_pasangan_pria}} & {{$pesananSemua->nama_pasangan_wanita}}</h3>
                                ...
                                <div class="bagikan">
                                    ...
                                    <h4 class="harga">Harga : <b>Rp. {{number_format($pesananSemua->harga)}}</b></h4>
                                </div>
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    @if ($pemesanan->status == 'pending')
                                                        <form method="POST" id="tombol-hapus">
                                                            @method('delete')
                                                            @csrf
                                                            <button type="button" onclick="hapusPesanan('{{$pemesanan->id_pemesanan}}')"  class="btn btn-danger">Hapus Pesanan</button>
                                                        </form>
                                                    @endif
