                        ...
                        <div class="container-fluid">
                            ...
                            <form method="POST" id="form-kategori-video">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="kategori" type="text" placeholder="Kategori">
...
@push('script')
    <script>
        ...
        let formHero = document.getElementById('form-kategori-video');
        formHero.addEventListener('submit', function(e) {
            e.preventDefault()

            let kategori = document.getElementById('kategori');

            axios.post("{{ route('kategori_video.store') }}", {
