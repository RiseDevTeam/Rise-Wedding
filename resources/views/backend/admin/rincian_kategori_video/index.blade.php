            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Rincian Kategori Video</h6>
                        <a href="{{ route('rincian_kategori_video.create') }}" class="btn btn-primary">Tambah Data</a>
                    </div>
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    @forelse ($rincian_kategori_video as $rincian)
                                        <tr>
                                            <td>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0">
                                                    {!! $rincian->rincian_kategori_video !!}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                @php
                                                    $id = Crypt::encrypt($rincian->id_rincian_kategori_video);
                                                @endphp
                                                <span class="badge badge-sm bg-gradient-success"><a
                                                        href="{{ route('rincian_kategori_video.edit', $id) }}"
                                                ...
                                                <form method="POST" id="formHeroDelete">
                                                    ...
                                                    <button type="button" class="badge badge-sm bg-gradient-danger mt-2"
                                                        onclick="hapusRincianKategori('{{ $rincian->id_rincian_kategori_video }}')"><i
        ...
        function hapusRincianKategori(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete(`rincian_kategori_video/${id}`)
