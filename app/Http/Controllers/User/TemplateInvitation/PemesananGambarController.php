...
class PemesananGambarController extends Controller
{
    public function data_gambar($id_template)
    {
        ...
        return view('frontend.template_invitation.form_data_gambar', compact('kategori', 'pemesanan', 'id_template', 'idPemesanan'));
    }
    ...
    public function data_gambar_premium(Request $request)
    {
